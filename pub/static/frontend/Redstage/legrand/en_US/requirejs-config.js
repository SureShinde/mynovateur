...
var config = {
    config: {
        mixins: {
            'Magento_Theme/js/view/breadcrumbs': {
                'Amasty_MegaMenuLite/js/mixins/breadcrumbs': true
            }
        }
    }
};
...
var config = { 
    paths: {
        slick: 'Redstage_AmcConfigurator/js/slick'
    },
    shim: {
        slick: {
            deps: ['jquery']
...
var config = { 
    paths: {
        slick: 'Redstage_BoqConfigurator/js/slick'
    },
    shim: {
        slick: {
            deps: ['jquery']
 ...
 * @author    Redstage
 * @copyright Copyright (c) Redstage - 2022, All rights are reserved
 */
var config = {
    map: {
        '*': {
            list :'Redstage_CustomWebkul/js/list/list'
        }
    }
};
