<?php
namespace PayUIndia\Payu\Model\Payu;

/**
 * Interceptor class for @see \PayUIndia\Payu\Model\Payu
 */
class Interceptor extends \PayUIndia\Payu\Model\Payu implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Model\Context $context, \Magento\Framework\Registry $registry, \Magento\Framework\Api\ExtensionAttributesFactory $extensionFactory, \Magento\Framework\Api\AttributeValueFactory $customAttributeFactory, \Magento\Payment\Helper\Data $paymentData, \Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig, \Magento\Payment\Model\Method\Logger $logger, \PayUIndia\Payu\Helper\Payu $helper, \Magento\Sales\Model\Order\Email\Sender\OrderSender $orderSender, \Magento\Framework\HTTP\ZendClientFactory $httpClientFactory, \Magento\Checkout\Model\Session $checkoutSession)
    {
        $this->___init();
        parent::__construct($context, $registry, $extensionFactory, $customAttributeFactory, $paymentData, $scopeConfig, $logger, $helper, $orderSender, $httpClientFactory, $checkoutSession);
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getReturnUrl', func_get_args(), $pluginInfo) : parent::getReturnUrl();
    }
    ...
    public function getCgiUrl()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getCgiUrl', func_get_args(), $pluginInfo) : parent::getCgiUrl();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'buildCheckoutRequest');
        return $pluginInfo ? $this->___callPlugins('buildCheckoutRequest', func_get_args(), $pluginInfo) : parent::buildCheckoutRequest();
    }

    /**
     * {@inheritdoc}
     */
    public function generatePayuHash($txnid, $amount, $productInfo, $name, $email, $udf1, $udf5)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'generatePayuHash');
        return $pluginInfo ? $this->___callPlugins('generatePayuHash', func_get_args(), $pluginInfo) : parent::generatePayuHash($txnid, $amount, $productInfo, $name, $email, $udf1, $udf5);
    }
    ...
    public function validateResponse($returnParams)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('validateResponse', func_get_args(), $pluginInfo) : parent::validateResponse($returnParams);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'postProcessing');
        return $pluginInfo ? $this->___callPlugins('postProcessing', func_get_args(), $pluginInfo) : parent::postProcessing($order, $payment, $response);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'verifyPayment');
        return $pluginInfo ? $this->___callPlugins('verifyPayment', func_get_args(), $pluginInfo) : parent::verifyPayment($order, $txnid);
    }
