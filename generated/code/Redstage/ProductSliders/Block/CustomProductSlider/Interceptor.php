<?php
namespace Redstage\ProductSliders\Block\CustomProductSlider;

/**
 * Interceptor class for @see \Redstage\ProductSliders\Block\CustomProductSlider
 */
class Interceptor extends \Redstage\ProductSliders\Block\CustomProductSlider implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Catalog\Block\Product\Context $context, \Magento\Catalog\Model\ResourceModel\Product\CollectionFactory $productsFactory, \Magento\Catalog\Model\CategoryFactory $categoryFactory, \Redstage\ProductSliders\Helper\Data $helperData, \Magento\Customer\Model\Session $customer, \Magento\Wishlist\Model\ResourceModel\Item\CollectionFactory $wishlistCollectionFactory, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $productsFactory, $categoryFactory, $helperData, $customer, $wishlistCollectionFactory, $data);
    }

    /**
     * {@inheritdoc}
     */
    public function getProductSliderItems(int $cat_id, string $custom_attribute_name, int $num_of_product)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductSliderItems');
        return $pluginInfo ? $this->___callPlugins('getProductSliderItems', func_get_args(), $pluginInfo) : parent::getProductSliderItems($cat_id, $custom_attribute_name, $num_of_product);
    }
    ...
    public function getCategoryName(int $cat_id)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getCategoryName', func_get_args(), $pluginInfo) : parent::getCategoryName($cat_id);
    }
    ...
    public function getCategoryURL(int $cat_id)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getCategoryURL', func_get_args(), $pluginInfo) : parent::getCategoryURL($cat_id);
    }
