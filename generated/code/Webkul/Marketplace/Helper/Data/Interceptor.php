...
class Interceptor extends \Webkul\Marketplace\Helper\Data implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getSellerCollectionObj($sellerId)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getSellerCollectionObj', func_get_args(), $pluginInfo) : parent::getSellerCollectionObj($sellerId);
    }
    ...
    public function getSellerCollectionObjByShop($shopUrl)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getSellerCollectionObjByShop', func_get_args(), $pluginInfo) : parent::getSellerCollectionObjByShop($shopUrl);
    }
    ...
    public function allowProductInCart($product)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('allowProductInCart', func_get_args(), $pluginInfo) : parent::allowProductInCart($product);
    }
