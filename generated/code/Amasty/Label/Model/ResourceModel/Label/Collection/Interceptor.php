<?php
namespace Amasty\Label\Model\ResourceModel\Label\Collection;

/**
 * Interceptor class for @see \Amasty\Label\Model\ResourceModel\Label\Collection
 */
class Interceptor extends \Amasty\Label\Model\ResourceModel\Label\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Data\Collection\EntityFactoryInterface $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, \Magento\Framework\Api\ExtensionAttribute\JoinProcessorInterface $extensionAttributesJoinProcessor, ?\Magento\Framework\DB\Adapter\AdapterInterface $connection = null, ?\Magento\Framework\Model\ResourceModel\Db\AbstractDb $resource = null)
    {
        $this->___init();
        parent::__construct($entityFactory, $logger, $fetchStrategy, $eventManager, $extensionAttributesJoinProcessor, $connection, $resource);
    }
    ...
    public function addActiveFilter() : void
    {
        ...
        $pluginInfo ? $this->___callPlugins('addActiveFilter', func_get_args(), $pluginInfo) : parent::addActiveFilter();
    }
    ...
    public function addStoreFilter($storeFilter) : void
    {
        ...
        $pluginInfo ? $this->___callPlugins('addStoreFilter', func_get_args(), $pluginInfo) : parent::addStoreFilter($storeFilter);
    }
    ...
    public function addCustomerGroupFilter($customerFilter) : void
    {
        ...
        $pluginInfo ? $this->___callPlugins('addCustomerGroupFilter', func_get_args(), $pluginInfo) : parent::addCustomerGroupFilter($customerFilter);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addIsNewFilterApplied');
        $pluginInfo ? $this->___callPlugins('addIsNewFilterApplied', func_get_args(), $pluginInfo) : parent::addIsNewFilterApplied();
    }

    /**
     * {@inheritdoc}
     */
    public function getItemById($idValue) : ?\Amasty\Label\Api\Data\LabelInterface
    {
    ...
    public function setMode(int $mode) : void
    {
        ...
        $pluginInfo ? $this->___callPlugins('setMode', func_get_args(), $pluginInfo) : parent::setMode($mode);
    }
