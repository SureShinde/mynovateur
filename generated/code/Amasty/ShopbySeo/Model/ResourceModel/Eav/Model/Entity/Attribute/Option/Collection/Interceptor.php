<?php
namespace Amasty\ShopbySeo\Model\ResourceModel\Eav\Model\Entity\Attribute\Option\Collection;

/**
 * Interceptor class for @see \Amasty\ShopbySeo\Model\ResourceModel\Eav\Model\Entity\Attribute\Option\Collection
 */
class Interceptor extends \Amasty\ShopbySeo\Model\ResourceModel\Eav\Model\Entity\Attribute\Option\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addAttributeFilter(array $attributeCodes)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addAttributeFilter', func_get_args(), $pluginInfo) : parent::addAttributeFilter($attributeCodes);
    }
    ...
    public function setAttributeFilter($setId)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setAttributeFilter', func_get_args(), $pluginInfo) : parent::setAttributeFilter($setId);
    }
    ...
    public function setStoreFilter($storeId = null, $useDefaultValue = true)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setStoreFilter', func_get_args(), $pluginInfo) : parent::setStoreFilter($storeId, $useDefaultValue);
    }
    ...
    public function setIdFilter($optionId)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setIdFilter', func_get_args(), $pluginInfo) : parent::setIdFilter($optionId);
    }
    ...
    public function toOptionArray($valueKey = 'value')
    {
        ...
        return $pluginInfo ? $this->___callPlugins('toOptionArray', func_get_args(), $pluginInfo) : parent::toOptionArray($valueKey);
    }
    ...
    public function setPositionOrder($dir = 'ASC', $sortAlpha = false)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setPositionOrder', func_get_args(), $pluginInfo) : parent::setPositionOrder($dir, $sortAlpha);
    }
