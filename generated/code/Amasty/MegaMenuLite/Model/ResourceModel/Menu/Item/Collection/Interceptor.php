<?php
namespace Amasty\MegaMenuLite\Model\ResourceModel\Menu\Item\Collection;

/**
 * Interceptor class for @see \Amasty\MegaMenuLite\Model\ResourceModel\Menu\Item\Collection
 */
class Interceptor extends \Amasty\MegaMenuLite\Model\ResourceModel\Menu\Item\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCustomItemByEntityId');
        return $pluginInfo ? $this->___callPlugins('getCustomItemByEntityId', func_get_args(), $pluginInfo) : parent::getCustomItemByEntityId($entityId);
    }
