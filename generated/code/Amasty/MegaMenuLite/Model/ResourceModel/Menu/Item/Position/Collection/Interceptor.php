<?php
namespace Amasty\MegaMenuLite\Model\ResourceModel\Menu\Item\Position\Collection;

/**
 * Interceptor class for @see \Amasty\MegaMenuLite\Model\ResourceModel\Menu\Item\Position\Collection
 */
class Interceptor extends \Amasty\MegaMenuLite\Model\ResourceModel\Menu\Item\Position\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSortedCollection');
        return $pluginInfo ? $this->___callPlugins('getSortedCollection', func_get_args(), $pluginInfo) : parent::getSortedCollection($storeId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinLinkTable');
        $pluginInfo ? $this->___callPlugins('joinLinkTable', func_get_args(), $pluginInfo) : parent::joinLinkTable();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addLinkTypeFilter');
        $pluginInfo ? $this->___callPlugins('addLinkTypeFilter', func_get_args(), $pluginInfo) : parent::addLinkTypeFilter($values);
    }
