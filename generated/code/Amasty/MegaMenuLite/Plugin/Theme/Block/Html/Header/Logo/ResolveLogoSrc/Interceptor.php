<?php
namespace Amasty\MegaMenuLite\Plugin\Theme\Block\Html\Header\Logo\ResolveLogoSrc;

/**
 * Interceptor class for @see \Amasty\MegaMenuLite\Plugin\Theme\Block\Html\Header\Logo\ResolveLogoSrc
 */
class Interceptor extends \Amasty\MegaMenuLite\Plugin\Theme\Block\Html\Header\Logo\ResolveLogoSrc implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Amasty\Base\Model\MagentoVersion $magentoVersion, \Amasty\MegaMenuLite\Model\ConfigProvider $configProvider, \Magento\Framework\UrlInterface $urlBuilder, \Magento\Framework\View\Element\Template\Context $context, \Magento\MediaStorage\Helper\File\Storage\Database $fileStorageHelper)
    {
        $this->___init();
        parent::__construct($magentoVersion, $configProvider, $urlBuilder, $context, $fileStorageHelper);
    }

    /**
     * {@inheritdoc}
     */
    public function afterGetLogoSrc(\Magento\Theme\Block\Html\Header\Logo $subject, string $path) : ?string
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'afterGetLogoSrc');
        return $pluginInfo ? $this->___callPlugins('afterGetLogoSrc', func_get_args(), $pluginInfo) : parent::afterGetLogoSrc($subject, $path);
    }
