<?php
namespace Amasty\ShopbyBase\Model\ResourceModel\FilterSetting\CollectionExtended;

/**
 * Interceptor class for @see \Amasty\ShopbyBase\Model\ResourceModel\FilterSetting\CollectionExtended
 */
class Interceptor extends \Amasty\ShopbyBase\Model\ResourceModel\FilterSetting\CollectionExtended implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Amasty\ShopbyBase\Helper\FilterSetting $filterSettingHelper, \Magento\Framework\Data\Collection\EntityFactoryInterface $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, ?\Magento\Framework\DB\Adapter\AdapterInterface $connection = null, ?\Magento\Framework\Model\ResourceModel\Db\AbstractDb $resource = null)
    {
        $this->___init();
        parent::__construct($filterSettingHelper, $entityFactory, $logger, $fetchStrategy, $eventManager, $connection, $resource);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemByCode');
        return $pluginInfo ? $this->___callPlugins('getItemByCode', func_get_args(), $pluginInfo) : parent::getItemByCode($filterCode);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemByAttribute');
        return $pluginInfo ? $this->___callPlugins('getItemByAttribute', func_get_args(), $pluginInfo) : parent::getItemByAttribute($attributeModel);
    }
