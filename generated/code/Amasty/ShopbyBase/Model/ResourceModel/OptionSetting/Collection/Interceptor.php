<?php
namespace Amasty\ShopbyBase\Model\ResourceModel\OptionSetting\Collection;

/**
 * Interceptor class for @see \Amasty\ShopbyBase\Model\ResourceModel\OptionSetting\Collection
 */
class Interceptor extends \Amasty\ShopbyBase\Model\ResourceModel\OptionSetting\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Data\Collection\EntityFactoryInterface $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, \Magento\Eav\Model\ResourceModel\Entity\Attribute\Option\CollectionFactory $optionCollectionFactory, ?\Magento\Framework\DB\Adapter\AdapterInterface $connection = null, ?\Magento\Framework\Model\ResourceModel\Db\AbstractDb $resource = null)
    {
        $this->___init();
        parent::__construct($entityFactory, $logger, $fetchStrategy, $eventManager, $optionCollectionFactory, $connection, $resource);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addLoadParams');
        return $pluginInfo ? $this->___callPlugins('addLoadParams', func_get_args(), $pluginInfo) : parent::addLoadParams($filterCode, $optionId, $storeId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getHardcodedAliases');
        return $pluginInfo ? $this->___callPlugins('getHardcodedAliases', func_get_args(), $pluginInfo) : parent::getHardcodedAliases($storeId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getValueFromMagentoEav');
        return $pluginInfo ? $this->___callPlugins('getValueFromMagentoEav', func_get_args(), $pluginInfo) : parent::getValueFromMagentoEav($value, $storeId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addTitleToCollection');
        return $pluginInfo ? $this->___callPlugins('addTitleToCollection', func_get_args(), $pluginInfo) : parent::addTitleToCollection();
    }
