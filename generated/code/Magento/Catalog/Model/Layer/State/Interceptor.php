...
class Interceptor extends \Magento\Catalog\Model\Layer\State implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setFilters');
        return $pluginInfo ? $this->___callPlugins('setFilters', func_get_args(), $pluginInfo) : parent::setFilters($filters);
    }
