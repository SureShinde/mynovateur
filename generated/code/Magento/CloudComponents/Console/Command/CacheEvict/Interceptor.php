<?php
namespace Magento\CloudComponents\Console\Command\CacheEvict;

/**
 * Interceptor class for @see \Magento\CloudComponents\Console\Command\CacheEvict
 */
class Interceptor extends \Magento\CloudComponents\Console\Command\CacheEvict implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\CloudComponents\Model\Cache\Evictor $evictor)
    {
        $this->___init();
        parent::__construct($evictor);
    }
