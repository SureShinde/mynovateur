<?php
namespace Magento\CloudComponents\Console\Command\ConfigShowDefaultUrlCommand;

/**
 * Interceptor class for @see \Magento\CloudComponents\Console\Command\ConfigShowDefaultUrlCommand
 */
class Interceptor extends \Magento\CloudComponents\Console\Command\ConfigShowDefaultUrlCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Store\Model\StoreManagerInterface $storeManager, \Magento\CloudComponents\Model\UrlFixer $urlFixer)
    {
        $this->___init();
        parent::__construct($storeManager, $urlFixer);
    }
