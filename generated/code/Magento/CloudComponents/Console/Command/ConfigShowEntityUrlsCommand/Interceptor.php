<?php
namespace Magento\CloudComponents\Console\Command\ConfigShowEntityUrlsCommand;

/**
 * Interceptor class for @see \Magento\CloudComponents\Console\Command\ConfigShowEntityUrlsCommand
 */
class Interceptor extends \Magento\CloudComponents\Console\Command\ConfigShowEntityUrlsCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Store\Model\StoreManagerInterface $storeManager, \Magento\CloudComponents\Model\UrlFinderFactory $urlFinderFactory, \Magento\Framework\App\State $state)
    {
        $this->___init();
        parent::__construct($storeManager, $urlFinderFactory, $state);
    }
