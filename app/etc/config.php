...
return [
    'modules' => [
        ...
        'PayUIndia_Payu' => 1,
        'Redstage_AmcConfigurator' => 1,
        'Redstage_Base' => 1,
        'Redstage_BoqConfigurator' => 1,
        'Redstage_Carousel' => 1,
        'Redstage_CartConfigurator' => 1,
        'Redstage_Catalog' => 1,
        'Redstage_CmsPages' => 1,
        'Redstage_CompareProducts' => 1,
        'Redstage_Contact' => 1,
        'Redstage_CreateAttributes' => 1,
        'Redstage_CustomCreditmemo' => 1,
        'Webkul_Marketplace' => 1,
        'Redstage_CustomerInstallation' => 1,
        'Redstage_CustomerSync' => 1,
        'Redstage_Customsms' => 1,
        'Redstage_DumpServiceTicket' => 1,
        'Redstage_Invoice' => 1,
        'Redstage_LayeredNavigation' => 1,
        'Redstage_Logger' => 1,
        'Redstage_OrderExport' => 1,
        'Redstage_OrderInstallation' => 1,
        'Redstage_ProductSliders' => 1,
        'Redstage_ProductviewPrice' => 1,
        'Redstage_SalesForce' => 1,
        'Redstage_SalesReport' => 1,
        'Redstage_SendEmail' => 1,
        'Redstage_ServiceTicket' => 1,
        'Redstage_ServiceTicketsync' => 1,
        'Redstage_Services' => 1,
        'Redstage_Warranty' => 1,
        ...
        'Webkul_CoreFix' => 1,
        'Webkul_CustomInvoice' => 1,
        'Webkul_DelhiveryExtend' => 1,
        'Webkul_DelhiveryShipping' => 1,
        'Webkul_MpAssignProduct' => 1,
        'Webkul_MarketplaceBaseShipping' => 1,
        'Webkul_MarketplaceGstIndia' => 1,
        'Redstage_CustomWebkul' => 1,
