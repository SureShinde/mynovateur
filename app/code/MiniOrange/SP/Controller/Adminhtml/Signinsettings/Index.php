...
class Index extends BaseAdminAction
{
    ...
    private function processValuesAndSaveData($params)
    {
        ...
        */
        ...
        $mo_saml_auto_create_admin = isset($params['mo_saml_auto_create_admin']) ? 1 : 0;
        $mo_saml_auto_create_customer = isset($params['mo_saml_auto_create_customer']) ? 1 : 0;
        ...
        $this->spUtility->setStoreConfig(SPConstants::AUTO_CREATE_ADMIN, $mo_saml_auto_create_admin);
        $this->spUtility->setStoreConfig(SPConstants::AUTO_CREATE_CUSTOMER, $mo_saml_auto_create_customer);
