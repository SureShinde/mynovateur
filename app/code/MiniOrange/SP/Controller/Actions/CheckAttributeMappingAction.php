...
class CheckAttributeMappingAction extends BaseAction
{
                                ...
                                \MiniOrange\SP\Controller\Actions\ProcessUserAction $processUserAction)
	{
        ...
        $this->groupName = $spUtility->isBlank($this->groupName) ? SPConstants::MAP_GROUP : $this->groupName;
    ...
    private function processEmail(&$attrs)
    {
        if(!isset($attrs[$this->emailAttribute]))
            ...
            $this->spUtility->log_debug(" inside CheckAttributeMappingAction : processEmail: Changed processEmail: ". $attrs[$this->emailAttribute][0]);
    }
