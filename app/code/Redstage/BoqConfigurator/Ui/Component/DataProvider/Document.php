...
namespace Redstage\BoqConfigurator\Ui\Component\DataProvider;
...
class Document extends \Magento\Framework\View\Element\UiComponent\DataProvider\Document
{
     ...
     * @var string
     */
    private static $prductGroupAttributeCode= 'product_group';

    /**
     * @var string
     */
    private static $productRangeAttributeCode = 'product_range';
    ...
    public function getCustomAttribute($attributeCode)
    {
        switch ($attributeCode) {
            case self::$prductGroupAttributeCode:
                $this->setprductGroupValue();
                break;
            case self::$productRangeAttributeCode:
                $this->setproductRangeValue();
                break;
     ...
     */
    private function setprductGroupValue()
    {
        $value = $this->getData(self::$prductGroupAttributeCode);

        if (!$value) {
            $this->setCustomAttribute(self::$prductGroupAttributeCode, 'N/A');
            return;
        }
