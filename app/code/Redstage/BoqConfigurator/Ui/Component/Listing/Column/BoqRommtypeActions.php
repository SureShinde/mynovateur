...
/**
 * Class BoqRoomtypeActions
 */
class BoqRoomtypeActions extends Column
{
    /**
     * Url path
     */
    
    const URL_PATH_EDIT = 'configuratoradmin/boqroomtype/edit';
    const URL_PATH_DELETE = 'configuratoradmin/boqroomtype/delete';
