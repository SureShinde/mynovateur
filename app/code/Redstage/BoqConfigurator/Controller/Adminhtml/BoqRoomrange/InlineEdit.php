...
class InlineEdit extends \Magento\Backend\App\Action
{
    ...
    {
        return '[BoqRoomtype ID: ' . $boqroomrange->getId() . '] ' . $errorText;
    }
    ...
    {
        return $this->_authorization->isAllowed('Redstage_BoqConfigurator::boqroomrange_create') ||
        $this->_authorization->isAllowed('Redstage_BoqConfigurator::boqroomrange_update');
    }
}
