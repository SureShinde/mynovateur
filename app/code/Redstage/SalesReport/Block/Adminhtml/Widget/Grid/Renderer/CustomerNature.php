...
class CustomerNature extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\Text
{
    /**
    ...
    public function _getValue(DataObject $row)
    {
        ...
        if($value){
            $customerData = $this->_customerFactory->create()->load($value);
            return $customerData->getGstin();
        } 
        return '';
    }
}