...
class PartnerCode extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\Text
{
    /**
    ...
    public function _getValue(DataObject $row)
    {
        ...
        if($value){
            $partnerCode = $this->_customerFactory->create()->load($value);
            return $partnerCode->getSapCustomerCode();
        } 
        return '';
    }
}