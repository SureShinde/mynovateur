 ...
 */
namespace Redstage\CustomCreditmemo\Controller\Adminhtml\Order\Creditmemo;
    ...
    public function execute()
    {
        ...
        try {
            ...
            if ($creditmemo) {
                ...
                if (!empty($data['pay_reference_id'])) {
                    $creditmemo->setPayReferenceId($data['pay_reference_id']);
                }
