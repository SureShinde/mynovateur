 ...
 */
class CreditmemoPay implements ObserverInterface
{
    /**
     * Https request
     *
    ...
    public function execute(Observer $observer)
    {
        ...
        //Getting Sender ID
        $this->senderId = $this->_helper->getCustomerSenderIdonCreditmemo();

        //Getting Message
        $this->message  = $this->_helper->getCustomerMessageOnCreditmemo();

        //Getting Customer Notification value
        $this->enabled  = $this->_helper->isCustomerNotificationsEnabledOnCreditmemo();
        ...
        if ($this->enabled == 1) {
            ...
            if ($verificationResult == true) {
                ...
                $orderData = [
                    ...
                    'creditmemo_id' => $order->getIncrementId(),
                ...
                //Manipulating SMS
                $this->message = $this->_helper->manipulateCreditmemoSMS($this->message, $orderData);
                ...
                if ($this->_helper->isAdminNotificationsEnabled() == 1) {
                    ...
                    $this->message = $this->_helper->getAdminMessageForCreditmemo();
                    $this->message = $this->_helper->manipulateCreditmemoSMS($this->message, $orderData);
                    $this->_helper->sendSms($this->username,
                        $this->password,
                        $this->senderId,
