...
namespace Redstage\CartConfigurator\CustomerData;
...
class DefaultItem extends \Magento\Checkout\CustomerData\DefaultItem
{
    ...
    protected function doGetItemData()
    {
        ...
        return [
            ...
            'is_visible_in_cart' => $this->item->getIsVisible(),
            ...
            'product_display_price' => $this->checkoutHelper->formatPrice($this->item->getDisplayPrice()),
            'raw_display_price' => $this->item->getDisplayPrice(),
