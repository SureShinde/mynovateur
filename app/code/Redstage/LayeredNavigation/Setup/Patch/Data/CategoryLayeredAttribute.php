...
namespace Redstage\LayeredNavigation\Setup\Patch\Data;
...
class CategoryLayeredAttribute implements DataPatchInterface
{
    /**
    ...
    public function apply()
    {
        ...
        if (!$eavSetup->getAttribute('catalog_category', 'layer_image')) {
