...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    const SELLER_STATUS_ACCEPTED = 5;
    ...
    public function getOrdersOfCustomer($customerId = '')
    {
        ...
        $allowedStatus = ['pending', 'processing', 'delivered'];
        if ($customerId == '') {
    ...
    public function getSellerStatusTitle($status)
    {
        ...
        } elseif ($status == self::SELLER_STATUS_ACCEPTED) {
    ...
    public function getAllStatus($resolutionType, $productType, $orderStatus = 1)
    {
        if ($resolutionType == self::RESOLUTION_CANCEL) {
            $allStatus = [
                            // self::SELLER_STATUS_ACCEPTED => __('Accepted'),
    ...
    public function sendNewRmaEmail($details = [])
    {
        ...
        $templateVars = [
                            ...
                            'order_status' => $orderStatus->getText(),
                            'resolution_type' => $resolutionType->getText(),
    ...
    public function sendUpdateRmaEmail($details = [])
    {
        ...
        $templateVars = [
                            ...
                            'rma_status' => $rmaStatusTitle->getText(),
