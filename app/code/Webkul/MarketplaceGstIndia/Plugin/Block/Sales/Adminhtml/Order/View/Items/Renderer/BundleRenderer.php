...
use Magento\Bundle\Block\Adminhtml\Sales\Order\Items\Renderer as MagentoBundleRenderer;
...
class BundleRenderer
{
     ...
     *
     * @param MagentoBundleRenderer $bundleRenderer
    ...
    public function aroundGetColumnHtml(
        MagentoBundleRenderer $bundleRenderer,
        \Closure $proceed,
        ...
        if (in_array($column, $customColumns)) {
            $html = $item->getOrderItem()->getOrder()->formatPrice($item->getData($column));
