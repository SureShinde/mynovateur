...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    {
        $collection = $this->_mpProductCollectionFactory->create();
        $collection->addFieldToFilter('mage_pro_row_id', $productId);
    ...
    {
        $querydata = $this->getSellerProducts($sellerId);
        $collection = $this->_productCollectionFactory->create();
        $collection->addAttributeToSelect('*');
        $collection->addAttributeToFilter('entity_id', ['in' => $querydata]);
    ...
    {
        $productIds = $this->itemsFactory->create()
                        ->getCollection()
                        ->addFieldToFilter(
                            'seller_id',
                            ['eq' => $sellerId]
