...
abstract class Order extends Action
{
    ...
    public function __construct(
        ...
        $this->creditmemoManagement = $creditmemoManagement ?: \Magento\Framework\App\ObjectManager::getInstance()
        ...
        $this->fileFactory = $fileFactory ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(FileFactory::class);
        $this->creditmemoPdf = $creditmemoPdf ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(\Webkul\Marketplace\Model\Order\Pdf\Creditmemo::class);
        $this->invoicePdf = $invoicePdf ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(\Webkul\Marketplace\Model\Order\Pdf\Invoice::class);
        $this->mpOrdersModel = $mpOrdersModel ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(MpOrdersModel::class);
        $this->invoiceCollection = $invoiceCollection ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(InvoiceCollection::class);
        $this->invoiceManagement = $invoiceManagement ?: \Magento\Framework\App\ObjectManager::getInstance()
        ...
        $this->mpSellerModel = $mpSellerModel ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->create(MpSellerModel::class);
    ...
    protected function _initInvoice()
    {
        ...
        try {
            ...
            $this->helper->logDataInLogger(
                "Controller_Order _initInvoice : ".$e->getMessage()
            );
            $this->_actionFlag->set('', self::FLAG_NO_DISPATCH, true);
    ...
    protected function _initShipment()
    {
        ...
        try {
            ...
            $tracking = $this->orderHelper->getOrderinfo($orderId);
            if ($tracking) {
                if (true || $tracking->getShipmentId() == $shipmentId) {
                    if (!$shipmentId) {
            ...
            $this->helper->logDataInLogger(
                "Controller_Order _initShipment : ".$e->getMessage()
            );
            $this->_actionFlag->set('', self::FLAG_NO_DISPATCH, true);
    ...
    protected function _initCreditmemo()
    {
        ...
        try {
            ...
            $this->helper->logDataInLogger(
                "Controller_Order _initCreditmemo : ".$e->getMessage()
            );
