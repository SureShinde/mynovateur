...
class Flags extends AbstractModifier
{
                    ...
                    'arguments' => [
                        'data' => [
                            'config' => [
                                ...
                                'imports' => [
                                    'productId' => '${ $.provider }:data.product.seller_product_id',
                                    '__disableTmpl' => ['productId' => false],
                                ],
                                'exports' => [
                                    'productId' => '${ $.externalProvider }:params.seller_product_id',
                                    '__disableTmpl' => ['productId' => false],
                                ],
                            ],
                        ],
    ...
    public function modifyData(array $data)
    {
        ...
        $data[$productId][self::DATA_SOURCE_DEFAULT]['seller_product_id'] = $productId;
        return $data;
    }
}
