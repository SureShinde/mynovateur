...
/**
 * Webkul DelhiveryShipping Pickup History Controller.
 */
    ...
    public function execute()
    {
        ...
        if ($isPartner == 1) {
            ...
            if ($helper->getIsSeparatePanel()) {
                $resultPage->addHandle('delhiveryextend_layout2_pickup_history');
            }
            $resultPage->getConfig()->getTitle()->set(__('Seller Scheduled Pickup'));
