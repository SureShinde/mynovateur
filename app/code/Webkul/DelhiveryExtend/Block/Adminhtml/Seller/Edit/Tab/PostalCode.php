...
namespace Webkul\DelhiveryExtend\Block\Adminhtml\Seller\Edit\Tab;

use Magento\Customer\Controller\RegistryConstants;

class PostalCode extends \Magento\Backend\Block\Template
{
    /**
     * Block template.
     *
     * @var string
     */
    protected $_template = 'seller/assign_postal_code.phtml';
    ...
    public function getBlockGrid()
    {
        if (null === $this->blockGrid) {
            $this->blockGrid = $this->getLayout()->createBlock(
                \Webkul\DelhiveryExtend\Block\Adminhtml\Seller\Edit\Tab\Grid\PostalCode::class,
                'seller.postalcode.grid'
            );
        }
    ...
    {
        $productIds = $this->pinSellerMapFactory->create()->getCollection()
    ...
    public function getSellerAssignedPostalCodeJson()
    {
        ...
        if (!empty($pincodeIds)) {
            return $this->jsonEncoder->encode(array_flip($pincodeIds));
        }
    ...
    {
        return __('Postal Code Assignment');
    }
