 ...
 */
namespace Webkul\CustomInvoice\Controller\Info;
    ...
    public function execute()
    {
        if ($this->getRequest()->isPost()) {
            ...
            try {
                ...
                $this->messageManager->addSuccess(__('PAN/CIN saved successfully.'));
            } catch (\Exception $e) {
                throw new \Magento\Framework\Exception(__('Can not save the records.'));
            }
        }
        return $this->resultRedirectFactory->create()->setPath('mpgst/config/view');
    }
}
