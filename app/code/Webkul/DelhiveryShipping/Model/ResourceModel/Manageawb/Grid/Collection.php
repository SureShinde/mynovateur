 ...
 */
namespace Webkul\DelhiveryShipping\Model\ResourceModel\Manageawb\Grid;

use Magento\Framework\Api\Search\SearchResultInterface as ApiSearchResultInterface;
use Webkul\DelhiveryShipping\Model\ResourceModel\Manageawb\Collection as ManageawbCollection;
...
/**
 * Webkul\DelhiveryShipping\Model\ResourceModel\Manageawb\Grid\Collection Class
 * Collection for displaying grid of Manage AWB.
 */
class Collection extends ManageawbCollection implements ApiSearchResultInterface
{
    /**
   ...
   {
       $joinTable2 = $this->getTable('sales_shipment');
       $this->getSelect()->join(
           $joinTable2.' as ss',
           'main_table.shipment_id = ss.entity_id',
           [
               'increment_id'=> 'ss.increment_id'
           ]
       );
